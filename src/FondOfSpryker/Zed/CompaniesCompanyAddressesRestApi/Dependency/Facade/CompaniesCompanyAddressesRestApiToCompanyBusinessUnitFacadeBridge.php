...
class CompaniesCompanyAddressesRestApiToCompanyBusinessUnitFacadeBridge implements
    CompaniesCompanyAddressesRestApiToCompanyBusinessUnitFacadeInterface
{
    /**
