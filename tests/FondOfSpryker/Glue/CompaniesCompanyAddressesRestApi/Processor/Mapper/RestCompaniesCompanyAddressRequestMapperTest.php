...
class RestCompaniesCompanyAddressRequestMapperTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfSpryker\Glue\CompaniesCompanyAddressesRestApi\Processor\Mapper\RestCompaniesCompanyAddressRequestMapper
     */
    ...
    protected function _before(): void
    {
        ...
        $this->restCompaniesCompanyAddressRequestMapper = new RestCompaniesCompanyAddressRequestMapper(
    ...
    public function testFromRestRequest(): void
    {
        ...
        $restCompaniesCompanyAddressRequestTransfer = $this->restCompaniesCompanyAddressRequestMapper
            ->fromRestRequest($this->restRequestMock);

        static::assertEquals($idCustomer, $restCompaniesCompanyAddressRequestTransfer->getIdCustomer());
        static::assertEquals($companyUuid, $restCompaniesCompanyAddressRequestTransfer->getCompanyUuid());
        static::assertEquals($companyUnitAddressUuid, $restCompaniesCompanyAddressRequestTransfer->getCompanyUnitAddressUuid());
    }
}
